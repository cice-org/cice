...
impl ActionParams for TestParams {}
...
#[async_trait]
impl<PARAMS: ActionParams> Action<TestRuntime, PARAMS> for SimpleAction {
    async fn recognize(
        &self,
    ...
    async fn exec(&self, _runtime: &TestRuntime, _params: &PARAMS) -> Result<(), ExecError> {
...
#[async_trait]
impl<PARAMS: ActionParams> Action<TestRuntime, PARAMS> for DenyAction {
    async fn recognize(
        &self,
        _runtime: &TestRuntime,
        _params: &PARAMS,
...
#[async_trait]
impl<PARAMS: ActionParams> Action<TestRuntime, PARAMS> for ConfigurableAction {
    async fn recognize(
        &self,
        _runtime: &TestRuntime,
        _params: &PARAMS,
